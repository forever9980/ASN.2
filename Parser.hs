...
action_4 (12) = happyShift action_3
...
action_40 (17) = happyShift action_41
...
action_42 (17) = happyShift action_44
...
happyReduction_3 ((HappyAbsSyn8  happy_var_12) `HappyStk`
	_ `HappyStk`
	_ `HappyStk`
	_ `HappyStk`
...
happyReduce_8 = happyReduce 13 9 happyReduction_8
...
happyNewToken action sts stk (tk:tks) =
	...
	case tk of {
	TATOM _ happy_dollar_dollar -> cont 12;
	TOPENP _ -> cont 13;
	TCLOSEP _ -> cont 14;
	TOPENSQ _ -> cont 15;
	TCLOSESQ _ -> cont 16;
